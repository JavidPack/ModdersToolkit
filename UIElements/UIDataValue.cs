...
namespace ModdersToolkit.UIElements
{
	...
	class UIDataValue<T> 
	{
		...
		public UIDataValue(string label) : this()
		{
			this.label = label;
		}
	}
	...
	{
		public UIBoolDataValue(string label = "") : base(label)
		{
		}
	}
	...
	class UIFloatRangedDataValue : UIRangedDataValue<float>
	{
		...
		public UIFloatRangedDataValue(string label = "", float min = 0f, float max = 1f, bool enforceMin = false, bool enforceMax = false) : base(label, min, max, enforceMin, enforceMax)
		{
		}
	...
	{
		// ctor with alt Func and Action vs override.
		public UIIntRangedDataValue(string label = "", int min = 0, int max = 100, bool enforceMin = false, bool enforceMax = false) : base(label, min, max, enforceMin, enforceMax)
		{
		}
	...
	{
		public UIFloatRangedDataValueLogit(string label = "", float min = 0, float max = 1, bool enforceMin = false, bool enforceMax = false) : base(label, min, max, enforceMin, enforceMax)
		{
		}
